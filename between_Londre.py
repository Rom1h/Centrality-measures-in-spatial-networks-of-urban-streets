...
# -------------------------------
place_name = "Covent Garden, London, UK"
...
plot_cumulative_distribution_centrality(
    values=bw_values,
    title="Cumulative distribution of betweenness – Covent, Garden, London (1 mile)",
    output_file="betweenness_covent_garden_London_v1.png",
    model="exp",
)
