...
bc_G1 = list(betweenness_centrality(G1, normalized=True).values())
bc_G2 = list(betweenness_centrality(G2, normalized=True).values())

bc_datasets = [
    (bc_G1, "Randomized P=0", "steelblue"),
    (bc_G2, "Randomized P=0.2", "darkorange"),
]

plot_cumulative_distribution_centralities_p(
    bc_datasets,
    title="Comparison of Betweeness Centrality Distributions",
    output_file="comparison_betweeness.png",
    model="exp",
    method="CB"
)
...
#     output_file="comparison_information.png",
#     model="powerlaw",
#     method="CI"
# )