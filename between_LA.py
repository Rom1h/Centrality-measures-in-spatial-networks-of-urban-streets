...
# -------------------------------
# SELECT LOCATION IN LOS ANGELES
# -------------------------------
place_name = "HollyWood , Los Angeles, California, USA"

# Load full drive network for Los Angeles
...
plot_cumulative_distribution_centrality(
    values=bw_values,
    title=f"Cumulative distribution of betweenness_{place_name} (1 mile)",
    output_file=f"betweenness_{place_name}.png",
    model="gauss",
)
